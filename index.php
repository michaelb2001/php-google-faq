...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light m-0">
        <div class="container-fluid d-flex align-items-center m-0">
            ...
            <div class="collapse navbar-collapse d-flex align-items-center m-0" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active">Domande frequenti</a>
                    </li>
                </ul>
            </div>
        </div>
